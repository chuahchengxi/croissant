...
enum SettingsPage: Hashable {
    ...
    case mouse, switcher, keyDebounce, superKey, cutPaste, autoQuit, quitProtection, cleaner, uninstaller, urlCleaner, homebrew, appUpdates, media, clipboard, windowLayout, shelf, quickTools, textSnippets, screenshot, radialMenu, commandBar, killProcess, desktopPet
...
extension AppFeature {
    ...
    var settingsDestination: FeatureSettingsDestination {
        ...
        case .desktopPet: return FeatureSettingsDestination(.desktopPet)
...
enum FeatureVisibilitySupport {
    ...
    static func features(for page: SettingsPage) -> [AppFeature] {
        ...
        case .desktopPet: return [.desktopPet]
