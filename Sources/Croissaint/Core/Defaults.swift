...
enum DefaultsKey {
    ...
    // Set only while Croissaint owes a Bluetooth restore, so a Mac shut down
    ...
    static let desktopPetNotifications = "desktopPetNotifications"  // mirror system notifications onto the buddy (needs Full Disk Access)
    ...
    static let screenshotHideCroissaintWindows = "screenshotHideCroissaintWindows"
...
enum UpdateHighlightsInfo {
    ...
    static let releaseVersion = "0.1.2"
...
enum KeepAwakeActiveIcon: String, CaseIterable, Identifiable {
    case croissaint, coffee, eye, moon, light
    ...
    var menuBarDrop: CGFloat {
        ...
        case .croissaint, .eye, .moon: return 0
        }
    }

    func title(_ strings: Strings) -> String {
        switch self {
        case .croissaint: return strings.keepAwakeActiveIconCroissaint
...
enum Defaults {
    ...
    static let registeredDefaults: [String: Any] = [
        ...
        // Off by default: reading the notification store is a privacy-visible
        // step that needs Full Disk Access, so it waits to be asked for.
        DefaultsKey.desktopPetNotifications: false,
        ...
        DefaultsKey.screenshotHideCroissaintWindows: true,
