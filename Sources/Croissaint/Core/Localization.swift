...
extension Strings {
    static let ptBR = Strings(
        ...
        donateMessage: "O Croissaint é gratuito, independente e desenvolvido no meu tempo livre. Se você quiser contribuir financeiramente, o Buy Me a Coffee ajuda diretamente a manter o desenvolvimento avançando.",
...
extension Strings {
    static let enUS = Strings(
        ...
        donateMessage: "Croissaint is free, independent and built in my spare time. If you would like to contribute financially, Buy Me a Coffee directly helps me keep development moving forward.",
