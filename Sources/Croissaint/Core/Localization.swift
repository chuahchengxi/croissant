...
struct Strings: LanguageVariants {
    ...
    let keepAwakeActiveIconCroissaint: String
...
extension Strings {
    static let ptBR = Strings(
        statusIdleTooltip: "Croissaint: suspensão normal",
        statusActiveUntil: "Croissaint: ativo até",
        statusActiveIndefinite: "Croissaint: ativo indefinidamente",
        menuEnableAwake: "Ativar manter acordado",
        menuDisableAwake: "Desativar manter acordado",
        menuActivateFor: "Ativar por…",
        menuSettings: "Ajustes…",
        menuAbout: "Sobre o Croissaint",
        menuQuit: "Sair do Croissaint",
        menuHide: "Ocultar o Croissaint",
        ...
        keepAwakeActiveIconCroissaint: "Croissaint",
        ...
        notifyBatteryTitle: "Croissaint desativado",
        notifyBatteryBody: "Bateria baixa. A suspensão normal foi restaurada para proteger a carga.",
        adminPromptClamshellOn: "O Croissaint precisa da sua senha para manter o Mac ativo com a tampa fechada.",
        adminPromptClamshellOff: "O Croissaint precisa da sua senha para reativar a suspensão normal do Mac.",
        adminPromptRecover: "O Croissaint foi encerrado com a suspensão do Mac desativada. Digite a senha para restaurar a suspensão normal.",
        adminPromptUpdate: "O Croissaint precisa da sua senha para instalar a atualização.",
        adminPromptSudoersInstall: "O Croissaint vai criar uma regra restrita (somente pmset disablesleep) para alternar a tampa fechada sem pedir senha. Esta é a única vez que a senha será necessária.",
        adminPromptSudoersRemove: "O Croissaint vai remover a regra de tampa fechada sem senha.",

        settingsTitle: "Ajustes do Croissaint",
        tabGeneral: "Geral",
        tabEnergy: "Energia",
        ...
        advancedResetDescription: "Remove todas as permissões que você concedeu ao Croissaint (Acessibilidade, Gravação de Tela, Acesso Total ao Disco e outras), o item de início e a regra de tampa fechada. Útil para começar do zero ou antes de desinstalar. O app continua instalado.",
        ...
        advancedUninstallDescription: "Faz tudo acima e ainda apaga as preferências e move o Croissaint para a Lixeira, sem deixar rastro no sistema. O app fecha ao final. Você pode reinstalar quando quiser.",
        advancedUninstallButton: "Desinstalar o Croissaint completamente",
        advancedUninstallConfirmTitle: "Desinstalar o Croissaint?",
        advancedUninstallConfirmBody: "O Croissaint vai limpar as permissões, apagar as preferências e ir para a Lixeira, e então fechar. Esta ação não pode ser desfeita pelo app, mas ele fica na Lixeira até você esvaziá-la.",
        advancedUninstallFailedTitle: "A desinstalação parou",
        advancedUninstallFailedBody: "O Croissaint não conseguiu restaurar uma configuração do sistema que ele mudou: repouso, velocidade das ventoinhas ou aceleração do mouse. Nada foi removido. Tente de novo e permita o pedido de senha, se ele aparecer.",
        ...
        keepAwakeAutoStart: "Manter acordado ao abrir o Croissaint",
        ...
        switcherEnable: "Usar o alternador do Croissaint",
        ...
        switcherTakeOverSystemShortcutsCaption: "Desativa os atalhos correspondentes de apps e janelas do macOS somente enquanto o alternador do Croissaint estiver ativo. Todos os apps abertos continuam acessíveis.",
        ...
        uninstallerFDAHint: "Ative o Croissaint na lista. Se ele não aparecer, clique no + e escolha o Croissaint em Aplicativos. O acesso só vale depois de reabrir o app.",
        ...
        homebrewMissingBody: "O Croissaint pode abrir o Terminal com o instalador oficial do Homebrew. O Terminal mostra os passos e pede sua senha se precisar.",
        ...
        homebrewShellSetupBody: "O Homebrew está instalado, mas o Terminal ainda pode não encontrar o comando brew. O Croissaint pode abrir o Terminal com o comando de configuração.",
        ...
        homebrewTerminalFallback: "Esta operação precisa do Terminal para pedir a senha de administrador. O Croissaint não captura senhas.",
        ...
        updateNotifyTitle: "Atualização do Croissaint",
        ...
        updateNeedsApplicationsTitle: "Mova o Croissaint para Aplicativos",
        updateNeedsApplicationsBody: "O app está rodando de um lugar que não dá para atualizar, como a imagem de disco ou uma área temporária do sistema. Arraste o Croissaint para a pasta Aplicativos, abra de lá e tente de novo.",
        ...
        obStart: "Abrir o Croissaint",
        obStepWelcomeTitle: "Bem-vindo ao Croissaint",
        ...
        obStepDoneBody: "O Croissaint já está cuidando do seu Mac.",
        ...
        obLanguageUpdateBody: "O Croissaint agora fala vários idiomas. Escolha o que você prefere usar; dá para mudar quando quiser nos Ajustes.",
        ...
        cleaningNeedsAxBody: "Para bloquear o teclado com segurança, o Croissaint precisa da permissão de Acessibilidade. Conceda em Ajustes do Sistema e tente de novo.",
        ...
        donateHeading: "Ajude o Croissaint a continuar crescendo",
        donateMessage: "O Croissaint é gratuito, independente e desenvolvido no meu tempo livre. Se você quiser contribuir financeiramente, o GitHub Stars ajuda diretamente a manter o desenvolvimento avançando.",
        donateButton: "Apoiar no GitHub Stars",
        donateThanks: "Obrigado por estar aqui. 🖤",
        supportIntroTitle: "Ajude o Croissaint a continuar crescendo",
        supportIntroMessage: "Se você quiser apoiar financeiramente o desenvolvimento, o GitHub Stars é o único lugar para fazer isso.",
        supportIntroStarButton: "Dar uma estrela no GitHub",
        supportIntroStarMessage: "Apoio financeiro nunca é esperado. Dar uma estrela no GitHub ajuda mais pessoas a encontrar o Croissaint e faz uma diferença enorme no desenvolvimento.",
        ...
        showMenuBarIconCaption: "Se o ícone do Croissaint sumir (o macOS pode esconder ícones quando a barra de menus fica sem espaço, comum em Macs com notch), reabra o Croissaint pela pasta Aplicativos ou pelo Spotlight: isso recria o ícone e, se ele ainda estiver escondido, abre esta janela.",
        ...
        menuBarIconManagerHintFormat: "O %@ está aberto e pode estar guardando o ícone na seção oculta dele. Procure o Croissaint lá, ou configure o %@ para sempre mostrar o Croissaint.",
        ...
        cleanerNotifDenied: "As notificações do Croissaint estão desativadas no sistema.",
        cleanerNotifOpenSettings: "Abrir Ajustes de Notificações…",
        launchAtLoginNeedsApplications: "O app está rodando de um lugar que não permite abrir no login. Arraste o Croissaint para a pasta Aplicativos, abra de lá e ligue de novo.",
        launchAtLoginNeedsApproval: "O item de login está registrado, mas continua desligado nos Ajustes do Sistema. Abra Ajustes do Sistema › Geral › Itens de Início e Extensões e ligue o Croissaint em “Abrir ao iniciar sessão”.",
        ...
        mouseAccelerationCaption: "Remove a aceleração do cursor para os mouses conectados. A configuração anterior volta ao desligar esta opção ou sair do Croissaint.",
...
extension Strings {
    static let enUS = Strings(
        statusIdleTooltip: "Croissaint: normal sleep",
        statusActiveUntil: "Croissaint: awake until",
        statusActiveIndefinite: "Croissaint: awake indefinitely",
        menuEnableAwake: "Enable keep awake",
        menuDisableAwake: "Disable keep awake",
        menuActivateFor: "Activate for…",
        menuSettings: "Settings…",
        menuAbout: "About Croissaint",
        menuQuit: "Quit Croissaint",
        menuHide: "Hide Croissaint",
        ...
        notifyBatteryTitle: "Croissaint disabled",
        notifyBatteryBody: "Low battery. Normal sleep was restored to protect the charge.",
        adminPromptClamshellOn: "Croissaint needs your password to keep the Mac going with the lid closed.",
        adminPromptClamshellOff: "Croissaint needs your password to restore the Mac’s normal sleep.",
        adminPromptRecover: "Croissaint quit while the Mac’s sleep was disabled. Enter the password to restore normal sleep.",
        adminPromptUpdate: "Croissaint needs your password to install the update.",
        adminPromptSudoersInstall: "Croissaint will create a restricted rule (pmset disablesleep only) to toggle closed-lid mode without asking for a password. This is the only time the password is needed.",
        adminPromptSudoersRemove: "Croissaint will remove the password-free closed-lid rule.",

        settingsTitle: "Croissaint Settings",
        tabGeneral: "General",
        tabEnergy: "Energy",
        ...
        advancedResetDescription: "Removes every permission you granted Croissaint (Accessibility, Screen Recording, Full Disk Access and others), the login item and the closed-lid rule. Useful to start fresh or before uninstalling. The app stays installed.",
        ...
        advancedUninstallDescription: "Does all of the above, then removes the preferences and moves Croissaint to the Trash, leaving nothing behind. The app quits when done. You can reinstall anytime.",
        advancedUninstallButton: "Uninstall Croissaint completely",
        advancedUninstallConfirmTitle: "Uninstall Croissaint?",
        advancedUninstallConfirmBody: "Croissaint will clear its permissions, remove its preferences and move to the Trash, then quit. This can’t be undone from the app, but it stays in the Trash until you empty it.",
        advancedUninstallFailedTitle: "Uninstall stopped",
        advancedUninstallFailedBody: "Croissaint could not put back a system setting it changed: sleep, fan speed or mouse acceleration. Nothing was removed. Try again and allow the password request if it appears.",
        ...
        keepAwakeAutoStart: "Keep Awake when Croissaint opens",
        ...
        switcherEnable: "Use the Croissaint switcher",
        ...
        switcherTakeOverSystemShortcutsCaption: "Disables the matching macOS app and window shortcuts only while Croissaint’s switcher is active. All running apps stay reachable.",
        ...
        uninstallerFDAHint: "Turn Croissaint on in the list. If it isn’t there, click + and pick Croissaint from Applications. Access only applies after you reopen the app.",
        ...
        homebrewMissingBody: "Croissaint can open Terminal with the official Homebrew installer. Terminal shows the steps and asks for your password if needed.",
        ...
        homebrewShellSetupBody: "Homebrew is installed, but Terminal may not find the brew command yet. Croissaint can open Terminal with the setup command.",
        ...
        homebrewTerminalFallback: "This operation needs Terminal to ask for the administrator password. Croissaint does not capture passwords.",
        ...
        updateNotifyTitle: "Croissaint update",
        ...
        updateNeedsApplicationsTitle: "Move Croissaint to Applications",
        updateNeedsApplicationsBody: "The app is running from a place that cannot be updated, such as the disk image or a temporary system location. Drag Croissaint to the Applications folder, open it from there and try again.",
        ...
        obStart: "Open Croissaint",
        obStepWelcomeTitle: "Welcome to Croissaint",
        ...
        obStepDoneBody: "Croissaint is already looking after your Mac.",
        ...
        obLanguageUpdateBody: "Croissaint now speaks several languages. Choose the one you’d like to use; you can change it anytime in Settings.",
        ...
        cleaningNeedsAxBody: "To lock the keyboard safely, Croissaint needs Accessibility permission. Grant it in System Settings and try again.",
        ...
        donateHeading: "Help Croissaint keep growing",
        donateMessage: "Croissaint is free, independent and built in my spare time. If you would like to contribute financially, GitHub Stars directly helps me keep development moving forward.",
        donateButton: "Support on GitHub Stars",
        donateThanks: "Thank you for being here. 🖤",
        supportIntroTitle: "Help Croissaint keep growing",
        supportIntroMessage: "If you would like to support development financially, GitHub Stars is the one place to do it.",
        supportIntroStarButton: "Star Croissaint on GitHub",
        supportIntroStarMessage: "Financial support is never expected. A star on GitHub helps more people discover Croissaint and makes a real difference to its development.",
        ...
        showMenuBarIconCaption: "If Croissaint’s icon disappears (macOS can hide menu bar icons when the bar runs out of room, common on Macs with a notch), reopen Croissaint from Applications or Spotlight: that rebuilds the icon and, if it’s still hidden, opens this window.",
        ...
        menuBarIconManagerHintFormat: "%@ is open and may be keeping the icon in its hidden section. Look for Croissaint there, or set %@ to always show Croissaint.",
        ...
        cleanerNotifDenied: "Croissaint notifications are turned off in the system.",
        cleanerNotifOpenSettings: "Open Notification Settings…",
        launchAtLoginNeedsApplications: "The app is running from a place that cannot open at login. Drag Croissaint to the Applications folder, open it from there and turn this on again.",
        launchAtLoginNeedsApproval: "The login item is registered but still switched off in System Settings. Open System Settings › General › Login Items & Extensions and turn Croissaint on under Open at Login.",
        ...
        mouseAccelerationCaption: "Removes pointer acceleration for connected mice. Your previous setting returns when this is turned off or Croissaint quits.",
