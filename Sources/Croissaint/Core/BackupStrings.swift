...
extension BackupFeatureStrings {
    static let ko = BackupFeatureStrings(
        ...
        invalidFile: "이 파일은 유효한 Croissaint 백업이 아닙니다."
    )
}
...
extension BackupFeatureStrings {
    ...
    static let ptBR = BackupFeatureStrings(
        ...
        invalidFile: "Este arquivo não é um backup válido do Croissaint."
    )
    ...
    static let ru = BackupFeatureStrings(
        ...
        invalidFile: "Этот файл не является корректной резервной копией Croissaint."
    )
    ...
    static let es = BackupFeatureStrings(
        ...
        invalidFile: "Este archivo no es una copia de seguridad válida de Croissaint."
    )
    ...
    static let de = BackupFeatureStrings(
        ...
        invalidFile: "Diese Datei ist kein gültiges Croissaint-Backup."
    )
    ...
    static let ja = BackupFeatureStrings(
        ...
        invalidFile: "このファイルは有効なCroissaintのバックアップではありません。"
    )
    ...
    static let zhTW = BackupFeatureStrings(
        ...
        invalidFile: "此檔案不是有效的 Croissaint 備份。"
    )
    ...
    static let zhHK = BackupFeatureStrings(
        ...
        importConfirmBody: "目前設定將被檔案中的設定取代,App 會重新啟動。這台 Mac 上的其他內容不受影響。",
        importAction: "匯入並重新啟動",
        invalidFile: "此檔案不是有效嘅 Croissaint 備份。"
    )
}
