...
enum AppInfo {
    ...
    static let discordURL = URL(string: "https://github.com/chuahchengxi/croissant")!
    ...
    /// True for the local "Croissaint (Developer)" build (bundle id ends in `.dev`).
    ...
    static var buildCommit: String? {
        Bundle.main.object(forInfoDictionaryKey: "CroissaintBuildCommit") as? String
    }
}
