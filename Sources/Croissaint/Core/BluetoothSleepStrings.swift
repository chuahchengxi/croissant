...
extension BluetoothSleepStrings {
    static let enUS = BluetoothSleepStrings(
        ...
        restoreCaption: "Only when Croissaint was the one that switched it off.",
    ...
    static let ptBR = BluetoothSleepStrings(
        ...
        restoreCaption: "Apenas quando foi o Croissaint que o desligou.",
    ...
    static let tr = BluetoothSleepStrings(
        ...
        restoreCaption: "Yalnızca kapatan Croissaint olduğunda.",
    ...
    static let ru = BluetoothSleepStrings(
        ...
        restoreCaption: "Только если его выключил сам Croissaint.",
    ...
    static let es = BluetoothSleepStrings(
        ...
        restoreCaption: "Solo cuando fue Croissaint quien lo apagó.",
    ...
    static let de = BluetoothSleepStrings(
        ...
        restoreCaption: "Nur wenn Croissaint es ausgeschaltet hat.",
    ...
    static let fr = BluetoothSleepStrings(
        ...
        restoreCaption: "Uniquement si c’est Croissaint qui l’a coupé.",
    ...
    static let it = BluetoothSleepStrings(
        ...
        restoreCaption: "Solo quando è stato Croissaint a spegnerlo.",
    ...
    static let ja = BluetoothSleepStrings(
        ...
        restoreCaption: "Croissaintが切った場合のみ戻します。",
    ...
    static let ko = BluetoothSleepStrings(
        ...
        restoreCaption: "Croissaint가 껐을 때만 다시 켭니다.",
    ...
    static let zhHans = BluetoothSleepStrings(
        ...
        restoreCaption: "仅在蓝牙是由 Croissaint 关闭时。",
    ...
    static let zhTW = BluetoothSleepStrings(
        ...
        restoreCaption: "僅在藍牙是由 Croissaint 關閉時。",
    ...
    static let zhHK = BluetoothSleepStrings(
        ...
        restoreToggle: "Mac 喚醒時重新開啟藍牙",
        restoreCaption: "只在藍牙是由 Croissaint 關閉時。",
