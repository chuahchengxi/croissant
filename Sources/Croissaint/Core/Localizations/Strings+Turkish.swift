...
extension Strings {
    static let tr = Strings(
        ...
        showMenuBarIconCaption: "Croissaint simgesi kaybolursa (macOS, çubukta yer kalmadığında menü çubuğu simgelerini gizleyebilir; çentikli Mac'lerde yaygındır), Croissaint'i Uygulamalar'dan veya Spotlight'tan yeniden aç: bu simgeyi yeniden oluşturur ve hâlâ gizliyse bu pencereyi açar. Buraya zaten ulaşabiliyorsan yukarıdaki düğme de aynısını yapar. Menü çubuğunda daha az simge veya daha az Croissaint metriği tutmak bunu çok daha az olası kılar.",
