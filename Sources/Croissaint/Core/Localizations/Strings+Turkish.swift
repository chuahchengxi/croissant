...
extension Strings {
    static let tr = Strings(
        statusIdleTooltip: "Croissaint: normal uyku",
        statusActiveUntil: "Croissaint: şu zamana kadar uyanık",
        statusActiveIndefinite: "Croissaint: süresiz uyanık",
        ...
        menuAbout: "Croissaint Hakkında",
        menuQuit: "Croissaint’ten Çık",
        menuHide: "Croissaint’i Gizle",
        ...
        notifyBatteryTitle: "Croissaint devre dışı",
        notifyBatteryBody: "Pil düşük. Şarjı korumak için normal uyku geri yüklendi.",
        adminPromptClamshellOn: "Croissaint’in, Mac’i kapak kapalıyken çalıştırmak için parolana ihtiyacı var.",
        adminPromptClamshellOff: "Croissaint’in, Mac’in normal uykusunu geri yüklemek için parolana ihtiyacı var.",
        adminPromptRecover: "Mac’in uykusu kapalıyken Croissaint kapandı. Normal uykuyu geri yüklemek için parolayı gir.",
        adminPromptUpdate: "Croissaint güncellemeyi yüklemek için parolanıza ihtiyaç duyuyor.",
        adminPromptSudoersInstall: "Croissaint, parola sormadan kapak kapalı modunu açıp kapatmak için kısıtlı bir kural oluşturacak (yalnızca pmset disablesleep). Parolanın gerektiği tek zaman bu.",
        adminPromptSudoersRemove: "Croissaint, parolasız kapak kapalı kuralını kaldıracak.",

        settingsTitle: "Croissaint Ayarları",
        tabGeneral: "Genel",
        tabEnergy: "Enerji",
        ...
        advancedResetDescription: "Croissaint’e verdiğin tüm izinleri (Erişilebilirlik, Ekran Kaydı, Tam Disk Erişimi ve diğerleri), oturum açma öğesini ve kapak kapalı kuralını kaldırır. Sıfırdan başlamak veya kaldırmadan önce temizlemek için kullanışlıdır. Uygulama yüklü kalır.",
        ...
        advancedUninstallDescription: "Yukarıdakilerin hepsini yapar, ardından tercihleri kaldırır ve Croissaint’i Çöp Sepeti’ne taşır; geride hiçbir şey bırakmaz. İş bitince uygulama kapanır. İstediğin zaman yeniden yükleyebilirsin.",
        advancedUninstallButton: "Croissaint’i tamamen kaldır",
        advancedUninstallConfirmTitle: "Croissaint kaldırılsın mı?",
        advancedUninstallConfirmBody: "Croissaint izinlerini temizleyecek, tercihlerini kaldıracak ve Çöp Sepeti’ne taşınıp kapanacak. Bu işlem uygulama içinden geri alınamaz, ama Çöp Sepeti’ni boşaltana kadar orada kalır.",
        advancedUninstallFailedTitle: "Kaldırma durduruldu",
        advancedUninstallFailedBody: "Croissaint değiştirdiği bir sistem ayarını geri alamadı: uyku, fan hızı veya fare hızlandırması. Hiçbir şey silinmedi. Yeniden deneyin ve parola istenirse izin verin.",
        ...
        keepAwakeAutoStart: "Croissaint açılınca uyanık tut",
        ...
        switcherEnable: "Croissaint değiştiricisini kullan",
        ...
        switcherTakeOverSystemShortcutsCaption: "Eşleşen macOS uygulama ve pencere kısayollarını yalnızca Croissaint değiştiricisi etkinken kapatır. Çalışan tüm uygulamalara erişim korunur.",
        ...
        uninstallerFDAHint: "Listede Croissaint’i aç. Orada yoksa + düğmesine tıkla ve Uygulamalar’dan Croissaint’i seç. Erişim yalnızca uygulamayı yeniden açtıktan sonra geçerli olur.",
        ...
        homebrewMissingBody: "Croissaint, resmi Homebrew yükleyicisiyle Terminal’i açabilir. Terminal adımları gösterir ve gerekirse parolanı ister.",
        ...
        homebrewShellSetupBody: "Homebrew yüklü, ancak Terminal brew komutunu henüz bulamayabilir. Croissaint, kurulum komutuyla Terminal’i açabilir.",
        ...
        homebrewTerminalFallback: "Bu işlem, yönetici parolasını istemek için Terminal’e ihtiyaç duyar. Croissaint parolaları yakalamaz.",
        ...
        updateNotifyTitle: "Croissaint güncellemesi",
        ...
        updateNeedsApplicationsTitle: "Croissaint’i Uygulamalar klasörüne taşıyın",
        updateNeedsApplicationsBody: "Uygulama, disk görüntüsü veya geçici bir sistem konumu gibi güncellenemeyen bir yerden çalışıyor. Croissaint’i Uygulamalar klasörüne sürükleyin, oradan açın ve yeniden deneyin.",
        ...
        obStart: "Croissaint’i aç",
        obStepWelcomeTitle: "Croissaint’e hoş geldin",
        ...
        obStepDoneBody: "Croissaint Mac’inle ilgilenmeye başladı bile.",
        ...
        obLanguageUpdateBody: "Croissaint artık birçok dil konuşuyor. Kullanmak istediğin dili seç; bunu istediğin zaman Ayarlar’dan değiştirebilirsin.",
        ...
        cleaningNeedsAxBody: "Klavyeyi güvenle kilitlemek için Croissaint’in Erişilebilirlik iznine ihtiyacı var. Sistem Ayarları’ndan izin ver ve tekrar dene.",
        ...
        showMenuBarIconCaption: "Croissaint simgesi kaybolursa (macOS, çubukta yer kalmadığında menü çubuğu simgelerini gizleyebilir; çentikli Mac’lerde yaygındır), Croissaint’i Uygulamalar’dan veya Spotlight’tan yeniden aç: bu simgeyi yeniden oluşturur ve hâlâ gizliyse bu pencereyi açar.",
        ...
        menuBarIconManagerHintFormat: "%@ açık ve simgeyi gizli bölümünde tutuyor olabilir. Croissaint’i orada arayın veya %@ uygulamasını Croissaint’i her zaman gösterecek şekilde ayarlayın.",
        ...
        cleanerNotifDenied: "Croissaint bildirimleri sistemde kapalı.",
        cleanerNotifOpenSettings: "Bildirim ayarlarını aç…",
        launchAtLoginNeedsApplications: "Uygulama, oturum açılırken açılmaya izin vermeyen bir konumdan çalışıyor. Croissaint’i Uygulamalar klasörüne sürükleyin, oradan açın ve bu seçeneği yeniden açın.",
        launchAtLoginNeedsApproval: "Giriş ögesi kayıtlı, ancak Sistem Ayarları’nda hâlâ kapalı. Sistem Ayarları › Genel › Giriş Ögeleri ve Uzantılar’ı açın ve “Oturum açılırken aç” altında Croissaint’i açın.",
        ...
        mouseAccelerationCaption: "Bağlı farelerde işaretçi hızlandırmasını kaldırır. Seçenek kapatıldığında veya Croissaint’ten çıkıldığında önceki ayar geri yüklenir.",
