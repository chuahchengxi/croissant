...
extension Strings {
    static let ja = Strings(
        statusIdleTooltip: "Croissaint：通常のスリープ",
        statusActiveUntil: "Croissaint：次の時刻までスリープしない",
        statusActiveIndefinite: "Croissaint：解除するまでスリープしない",
        menuEnableAwake: "スリープ防止をオン",
        menuDisableAwake: "スリープ防止をオフ",
        menuActivateFor: "時間を指定してオン…",
        menuSettings: "設定…",
        menuAbout: "Croissaint について",
        menuQuit: "Croissaint を終了",
        menuHide: "Croissaint を隠す",
        ...
        notifyBatteryTitle: "Croissaint をオフにしました",
        notifyBatteryBody: "バッテリー残量が少なくなりました。充電を保護するため通常のスリープに戻しました。",
        adminPromptClamshellOn: "ふたを閉じても続けるには、Croissaint にパスワードが必要です。",
        adminPromptClamshellOff: "Mac の通常のスリープを元に戻すにはパスワードが必要です。",
        adminPromptRecover: "Mac のスリープを無効化したまま Croissaint が終了しました。通常のスリープに戻すにはパスワードを入力してください。",
        adminPromptUpdate: "アップデートをインストールするには Croissaint にパスワードが必要です。",
        adminPromptSudoersInstall: "ふたを閉じたモードをパスワードなしで切り替えられるよう、Croissaint が制限付きルール（pmset disablesleep のみ）を作成します。パスワードが必要なのはこの一度きりです。",
        adminPromptSudoersRemove: "パスワード不要のふたを閉じたモードのルールを Croissaint が削除します。",

        settingsTitle: "Croissaint 設定",
        tabGeneral: "一般",
        tabEnergy: "省エネルギー",
        ...
        advancedResetDescription: "Croissaint に許可したすべてのアクセス権（アクセシビリティ、画面収録、フルディスクアクセスなど）、ログイン項目、ふたを閉じたモードのルールを削除します。最初からやり直すときや、アンインストールの前に便利です。アプリはインストールされたまま残ります。",
        ...
        advancedUninstallDescription: "上記をすべて実行したうえで、環境設定を削除し、Croissaint をゴミ箱に移動して、何も残しません。完了後にアプリは終了します。いつでも再インストールできます。",
        advancedUninstallButton: "Croissaint を完全にアンインストール",
        advancedUninstallConfirmTitle: "Croissaint をアンインストールしますか？",
        advancedUninstallConfirmBody: "Croissaint はアクセス権を消去し、環境設定を削除し、ゴミ箱に移動してから終了します。この操作はアプリからは取り消せませんが、ゴミ箱を空にするまではゴミ箱に残ります。",
        advancedUninstallFailedTitle: "アンインストールを中止しました",
        advancedUninstallFailedBody: "Croissaint が変更したシステム設定（スリープ、ファンの回転数、マウス加速）を元に戻せませんでした。何も削除していません。もう一度試して、パスワードの入力を求められたら許可してください。",
        ...
        keepAwakeAutoStart: "Croissaint起動時にスリープを防ぐ",
        ...
        switcherEnable: "Croissaint のスイッチャーを使う",
        ...
        switcherTakeOverSystemShortcutsCaption: "Croissaint のスイッチャーが動作中の間だけ、対応する macOS のアプリとウインドウのショートカットを無効にします。実行中のすべてのアプリに切り替えられます。",
        ...
        uninstallerFDAHint: "リストで Croissaint をオンにします。表示されない場合は + をクリックし、アプリケーションから Croissaint を選びます。アクセス権はアプリを再度開いた後に有効になります。",
        ...
        homebrewMissingBody: "Croissaint は公式 Homebrew インストーラを Terminal で開けます。Terminal に手順が表示され、必要ならパスワードを求められます。",
        ...
        homebrewShellSetupBody: "Homebrew はインストールされていますが、Terminal がまだ brew コマンドを見つけられない場合があります。Croissaint は設定コマンドを Terminal で開けます。",
        ...
        homebrewTerminalFallback: "この操作では管理者パスワードを求めるために Terminal が必要です。Croissaint はパスワードを取得しません。",
        ...
        updateNotifyTitle: "Croissaint のアップデート",
        updateInstallFailedBody: "アップデートはダウンロードされましたが、適用できませんでした。GitHub のリリースページから最新版をダウンロードし、現在のアプリの上にドラッグして置き換えてください。",
        updateNeedsApplicationsTitle: "Croissaint を「アプリケーション」に移動してください",
        updateNeedsApplicationsBody: "アプリが、ディスクイメージやシステムの一時的な場所など、アップデートできない場所から実行されています。Croissaint を「アプリケーション」フォルダにドラッグし、そこから開いてからもう一度お試しください。",
        ...
        obStart: "Croissaint を開く",
        obStepWelcomeTitle: "Croissaint へようこそ",
        ...
        obStepDoneBody: "Croissaint はすでにあなたの Mac を見守っています。",
        ...
        obLanguageUpdateBody: "Croissaint が複数の言語に対応しました。使いたい言語を選んでください。設定でいつでも変更できます。",
        ...
        cleaningNeedsAxBody: "キーボードを安全にロックするには、Croissaint にアクセシビリティのアクセス権が必要です。システム設定で許可して、もう一度お試しください。",
        ...
        showMenuBarIconCaption: "Croissaint のアイコンが消えた場合（メニューバーに空きがなくなると macOS がアイコンを隠すことがあり、ノッチのある Mac でよく起こります）、アプリケーションまたは Spotlight から Croissaint を開き直してください。アイコンが再作成され、それでも隠れている場合はこのウインドウが開きます。",
        ...
        menuBarIconManagerHintFormat: "%@ が起動中で、アイコンを隠しセクションにしまっている可能性があります。そこで Croissaint を探すか、%@ で Croissaint を常に表示する設定にしてください。",
        ...
        cleanerNotifDenied: "Croissaint の通知がシステムでオフになっています。",
        cleanerNotifOpenSettings: "通知設定を開く…",
        launchAtLoginNeedsApplications: "ログイン時に開けない場所からアプリが実行されています。Croissaintをアプリケーションフォルダにドラッグし、そこから開いてもう一度オンにしてください。",
        launchAtLoginNeedsApproval: "ログイン項目は登録されていますが、システム設定ではオフのままです。「システム設定 › 一般 › ログイン項目と機能拡張」を開き、「ログイン時に開く」でCroissaintをオンにしてください。",
        ...
        mouseAccelerationCaption: "接続したマウスのポインタ加速を無効にします。オフにするか Croissaint を終了すると以前の設定に戻ります。",
