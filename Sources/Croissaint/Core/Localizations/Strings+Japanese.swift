...
extension Strings {
    static let ja = Strings(
        ...
        showMenuBarIconCaption: "Croissaint のアイコンが消えた場合（メニューバーに空きがなくなると macOS がアイコンを隠すことがあり、ノッチのある Mac でよく起こります）、アプリケーションまたは Spotlight から Croissaint を開き直してください。アイコンが再作成され、それでも隠れている場合はこのウインドウが開きます。ここまでたどり着けるなら、上のボタンでも同じことができます。メニューバーのアイコンを減らすか、Croissaint の計測値を減らすと、起こりにくくなります。",
