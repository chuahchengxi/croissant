...
extension Strings {
    static let es = Strings(
        statusIdleTooltip: "Croissaint: reposo normal",
        statusActiveUntil: "Croissaint: activo hasta",
        statusActiveIndefinite: "Croissaint: activo indefinidamente",
        menuEnableAwake: "Activar mantener activo",
        menuDisableAwake: "Desactivar mantener activo",
        menuActivateFor: "Activar durante…",
        menuSettings: "Ajustes…",
        menuAbout: "Acerca de Croissaint",
        menuQuit: "Salir de Croissaint",
        menuHide: "Ocultar Croissaint",
        ...
        notifyBatteryTitle: "Croissaint desactivado",
        notifyBatteryBody: "Batería baja. Se restauró el reposo normal para proteger la carga.",
        adminPromptClamshellOn: "Croissaint necesita tu contraseña para seguir con la tapa cerrada.",
        adminPromptClamshellOff: "Croissaint necesita tu contraseña para restaurar el reposo normal del Mac.",
        adminPromptRecover: "Croissaint se cerró mientras el reposo del Mac estaba desactivado. Introduce la contraseña para restaurar el reposo normal.",
        adminPromptUpdate: "Croissaint necesita tu contraseña para instalar la actualización.",
        adminPromptSudoersInstall: "Croissaint creará una regla restringida (solo pmset disablesleep) para alternar el modo de tapa cerrada sin pedir contraseña. Esta es la única vez que se necesita la contraseña.",
        adminPromptSudoersRemove: "Croissaint eliminará la regla de tapa cerrada sin contraseña.",

        settingsTitle: "Ajustes de Croissaint",
        tabGeneral: "General",
        tabEnergy: "Energía",
        ...
        advancedResetDescription: "Elimina todos los permisos que concediste a Croissaint (Accesibilidad, Grabación de pantalla, Acceso total al disco y otros), el ítem de inicio de sesión y la regla de tapa cerrada. Útil para empezar de cero o antes de desinstalar. La app sigue instalada.",
        ...
        advancedUninstallDescription: "Hace todo lo anterior y, además, elimina las preferencias y mueve Croissaint a la Papelera, sin dejar rastro. La app se cierra al terminar. Puedes reinstalarla cuando quieras.",
        advancedUninstallButton: "Desinstalar Croissaint por completo",
        advancedUninstallConfirmTitle: "¿Desinstalar Croissaint?",
        advancedUninstallConfirmBody: "Croissaint borrará sus permisos, eliminará sus preferencias y se moverá a la Papelera; después se cerrará. Esto no se puede deshacer desde la app, pero permanece en la Papelera hasta que la vacíes.",
        advancedUninstallFailedTitle: "La desinstalación se detuvo",
        advancedUninstallFailedBody: "Croissaint no pudo restaurar un ajuste del sistema que había cambiado: la suspensión, la velocidad de los ventiladores o la aceleración del ratón. No se eliminó nada. Inténtalo de nuevo y permite la solicitud de contraseña si aparece.",
        ...
        keepAwakeAutoStart: "Mantener activo al abrir Croissaint",
        ...
        switcherEnable: "Usar el selector de Croissaint",
        ...
        switcherTakeOverSystemShortcutsCaption: "Desactiva los atajos correspondientes de macOS solo mientras el selector de Croissaint está activo. Todas las apps abiertas siguen accesibles.",
        ...
        uninstallerFDAHint: "Activa Croissaint en la lista. Si no aparece, haz clic en + y elige Croissaint en Aplicaciones. El acceso solo se aplica después de volver a abrir la app.",
        ...
        homebrewMissingBody: "Croissaint puede abrir Terminal con el instalador oficial de Homebrew. Terminal muestra los pasos y pide tu contraseña si hace falta.",
        ...
        homebrewShellSetupBody: "Homebrew está instalado, pero Terminal quizá aún no encuentre el comando brew. Croissaint puede abrir Terminal con el comando de configuración.",
        ...
        homebrewTerminalFallback: "Esta operación necesita Terminal para pedir la contraseña de administrador. Croissaint no captura contraseñas.",
        ...
        updateNotifyTitle: "Actualización de Croissaint",
        ...
        updateNeedsApplicationsTitle: "Mueve Croissaint a Aplicaciones",
        updateNeedsApplicationsBody: "La app se está ejecutando desde un lugar que no se puede actualizar, como la imagen de disco o una ubicación temporal del sistema. Arrastra Croissaint a la carpeta Aplicaciones, ábrela desde ahí y vuelve a intentarlo.",
        ...
        obStart: "Abrir Croissaint",
        obStepWelcomeTitle: "Te damos la bienvenida a Croissaint",
        ...
        obStepDoneBody: "Croissaint ya está cuidando de tu Mac.",
        ...
        obLanguageUpdateBody: "Croissaint ahora habla varios idiomas. Elige el que quieras usar; puedes cambiarlo cuando quieras en Ajustes.",
        ...
        cleaningNeedsAxBody: "Para bloquear el teclado de forma segura, Croissaint necesita el permiso de Accesibilidad. Concédelo en Ajustes del Sistema e inténtalo de nuevo.",
        ...
        donateHeading: "Ayuda a que Croissaint siga creciendo",
        donateMessage: "Croissaint es gratis, independiente y lo desarrollo en mi tiempo libre. Si quieres contribuir económicamente, GitHub Stars ayuda directamente a mantener el desarrollo en marcha.",
        donateButton: "Apoyar en GitHub Stars",
        donateThanks: "Gracias por estar aquí. 🖤",
        supportIntroTitle: "Ayuda a que Croissaint siga creciendo",
        supportIntroMessage: "Si quieres apoyar económicamente el desarrollo, GitHub Stars es el único lugar para hacerlo.",
        supportIntroStarButton: "Dar una estrella a Croissaint en GitHub",
        supportIntroStarMessage: "Nunca se espera apoyo económico. Una estrella en GitHub ayuda a que más personas descubran Croissaint y marca una diferencia real en su desarrollo.",
        supportIntroCoffeeButton: "Apoyar en GitHub Stars",
        ...
        homebrewOfficialIntroMessage: "Croissaint ya se puede instalar directamente desde el catálogo oficial de Homebrew.",
        ...
        showMenuBarIconCaption: "Si el icono de Croissaint desaparece (macOS puede ocultar iconos de la barra de menús cuando se queda sin espacio, algo habitual en Macs con notch), vuelve a abrir Croissaint desde Aplicaciones o Spotlight: eso recrea el icono y, si sigue oculto, abre esta ventana.",
        ...
        menuBarIconManagerHintFormat: "%@ está abierto y puede estar guardando el icono en su sección oculta. Busca Croissaint ahí, o configura %@ para mostrar siempre Croissaint.",
        ...
        cleanerNotifDenied: "Las notificaciones de Croissaint están desactivadas en el sistema.",
        cleanerNotifOpenSettings: "Abrir ajustes de notificaciones…",
        launchAtLoginNeedsApplications: "La app se está ejecutando desde un lugar que no permite abrirse al iniciar sesión. Arrastra Croissaint a la carpeta Aplicaciones, ábrelo desde ahí y actívalo de nuevo.",
        launchAtLoginNeedsApproval: "El ítem de inicio está registrado, pero sigue desactivado en Ajustes del Sistema. Abre Ajustes del Sistema › General › Ítems de inicio y extensiones y activa Croissaint en “Abrir al iniciar sesión”.",
        ...
        mouseAccelerationCaption: "Elimina la aceleración del puntero para los ratones conectados. El ajuste anterior vuelve al desactivarlo o salir de Croissaint.",
