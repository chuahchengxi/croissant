...
extension Strings {
    static let es = Strings(
        ...
        discordIntroTitle: "La comunidad de Croissaint en Discord acaba de empezar",
        discordIntroMessage: "La comunidad de Croissaint es nueva y todavía está tomando forma. Únete desde el principio para conocer a otros usuarios y ayudar a crear un espacio acogedor alrededor de la app.",
        ...
        communityIntroFollowButton: "Seguir a @chuahchengxi en X",
        ...
        showMenuBarIconCaption: "Si el icono de Croissaint desaparece (macOS puede ocultar iconos de la barra de menús cuando se queda sin espacio, algo habitual en Macs con notch), vuelve a abrir Croissaint desde Aplicaciones o Spotlight: eso recrea el icono y, si sigue oculto, abre esta ventana. El botón de arriba hace lo mismo cuando ya puedes llegar hasta aquí. Mantener menos iconos en la barra de menús, o menos métricas en Croissaint, lo hace mucho menos probable.",
