...
extension Strings {
    static let ru = Strings(
        statusIdleTooltip: "Croissaint: обычный сон",
        statusActiveUntil: "Croissaint: активно до",
        statusActiveIndefinite: "Croissaint: активно без срока",
        menuEnableAwake: "Включить режим без сна",
        menuDisableAwake: "Выключить режим без сна",
        menuActivateFor: "Включить на…",
        menuSettings: "Настройки…",
        menuAbout: "О Croissaint",
        menuQuit: "Выйти из Croissaint",
        menuHide: "Скрыть Croissaint",
        ...
        notifyBatteryTitle: "Croissaint отключён",
        notifyBatteryBody: "Низкий заряд. Обычный сон восстановлен, чтобы сохранить батарею.",
        adminPromptClamshellOn: "Croissaint нужен ваш пароль, чтобы Mac продолжал работать с закрытой крышкой.",
        adminPromptClamshellOff: "Croissaint нужен ваш пароль, чтобы вернуть обычный режим сна Mac.",
        adminPromptRecover: "Croissaint завершился, пока сон Mac был отключён. Введите пароль, чтобы вернуть обычный режим сна.",
        adminPromptUpdate: "Croissaint нужен ваш пароль, чтобы установить обновление.",
        adminPromptSudoersInstall: "Croissaint создаст ограниченное правило (только pmset disablesleep), чтобы переключать режим закрытой крышки без запроса пароля. Пароль понадобится только сейчас.",
        adminPromptSudoersRemove: "Croissaint удалит правило для режима закрытой крышки без пароля.",

        settingsTitle: "Настройки Croissaint",
        tabGeneral: "Основное",
        tabEnergy: "Питание",
        ...
        advancedResetDescription: "Удаляет все разрешения, которые вы дали Croissaint (Универсальный доступ, Запись экрана, Полный доступ к диску и другие), элемент входа и правило закрытой крышки. Полезно, если хотите начать с чистого листа или перед удалением. Приложение останется установленным.",
        ...
        advancedUninstallDescription: "Сделает всё вышеперечисленное, затем удалит настройки и переместит Croissaint в Корзину без остатка. После завершения приложение закроется. Установить его снова можно в любой момент.",
        advancedUninstallButton: "Удалить Croissaint полностью",
        advancedUninstallConfirmTitle: "Удалить Croissaint?",
        advancedUninstallConfirmBody: "Croissaint очистит разрешения, удалит настройки и переместится в Корзину, после чего закроется. Это нельзя отменить из приложения, но файл останется в Корзине, пока вы её не очистите.",
        advancedUninstallFailedTitle: "Удаление остановлено",
        advancedUninstallFailedBody: "Croissaint не смог вернуть изменённую системную настройку: режим сна, скорость вентиляторов или ускорение мыши. Ничего не удалено. Повторите попытку и разрешите запрос пароля, если он появится.",
        ...
        keepAwakeAutoStart: "Не давать уснуть при запуске Croissaint",
        ...
        switcherEnable: "Использовать переключатель Croissaint",
        ...
        switcherTakeOverSystemShortcutsCaption: "Отключает соответствующие сочетания macOS только на время работы переключателя Croissaint. Все запущенные приложения остаются доступны.",
        ...
        uninstallerFDAHint: "Включите Croissaint в списке. Если его там нет, нажмите + и выберите Croissaint из папки «Программы». Доступ начнёт действовать только после повторного запуска приложения.",
        ...
        homebrewMissingBody: "Croissaint может открыть Терминал с официальным установщиком Homebrew. Терминал покажет шаги и при необходимости запросит ваш пароль.",
        ...
        homebrewShellSetupBody: "Homebrew установлен, но Терминал может ещё не видеть команду brew. Croissaint может открыть Терминал с нужной командой настройки.",
        ...
        homebrewTerminalFallback: "Для этой операции нужен Терминал, чтобы запросить пароль администратора. Croissaint не перехватывает пароли.",
        ...
        updateNotifyTitle: "Обновление Croissaint",
        ...
        updateNeedsApplicationsTitle: "Переместите Croissaint в папку «Программы»",
        updateNeedsApplicationsBody: "Приложение запущено из места, которое нельзя обновить, например из образа диска или временного системного расположения. Перетащите Croissaint в папку «Программы», откройте его оттуда и попробуйте снова.",
        ...
        obStart: "Открыть Croissaint",
        obStepWelcomeTitle: "Добро пожаловать в Croissaint",
        ...
        obStepDoneBody: "Croissaint уже заботится о вашем Mac.",
        ...
        obLanguageUpdateBody: "Теперь Croissaint говорит на нескольких языках. Выберите тот, который хотите использовать; в любой момент его можно сменить в Настройках.",
        ...
        cleaningNeedsAxBody: "Чтобы безопасно блокировать клавиатуру, Croissaint нужен доступ к Универсальному доступу. Выдайте его в Системных настройках и попробуйте снова.",
        ...
        showMenuBarIconCaption: "Если значок Croissaint исчезнет (macOS может скрывать значки строки меню, когда в ней не хватает места, что часто бывает на Mac с вырезом), откройте Croissaint снова из папки «Программы» или через Spotlight: это пересоздаст значок и, если он всё ещё скрыт, откроет это окно.",
        ...
        menuBarIconManagerHintFormat: "%@ запущен и, возможно, держит значок в своей скрытой секции. Поищите Croissaint там или настройте %@ всегда показывать Croissaint.",
        ...
        cleanerNotifDenied: "Уведомления Croissaint отключены в системе.",
        cleanerNotifOpenSettings: "Открыть настройки уведомлений…",
        launchAtLoginNeedsApplications: "Приложение запущено из места, из которого нельзя открываться при входе. Перетащите Croissaint в папку «Программы», откройте его оттуда и включите параметр снова.",
        launchAtLoginNeedsApproval: "Объект входа зарегистрирован, но в Системных настройках он выключен. Откройте «Системные настройки › Основные › Объекты входа и расширения» и включите Croissaint в разделе «Открывать при входе».",
        ...
        mouseAccelerationCaption: "Отключает ускорение указателя для подключённых мышей. Прежняя настройка вернётся после выключения функции или выхода из Croissaint.",
