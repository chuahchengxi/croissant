...
extension Strings {
    static let ko = Strings(
        ...
        showMenuBarIconCaption: "Croissaint 아이콘이 사라진 경우(메뉴 막대 공간이 부족하면 macOS가 아이콘을 숨길 수 있으며 노치가 있는 Mac에서 특히 흔합니다) 응용 프로그램 또는 Spotlight에서 Croissaint를 다시 여세요. 아이콘을 다시 만들고, 그래도 숨겨져 있으면 이 윈도우가 열립니다. 여기까지 왔다면 위 버튼으로도 같은 작업을 할 수 있습니다. 메뉴 막대 아이콘이나 Croissaint 지표 수를 줄이면 이런 일이 줄어듭니다.",
