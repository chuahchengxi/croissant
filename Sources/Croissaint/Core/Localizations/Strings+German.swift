...
extension Strings {
    static let de = Strings(
        statusIdleTooltip: "Croissaint: normaler Ruhezustand",
        statusActiveUntil: "Croissaint: aktiv bis",
        statusActiveIndefinite: "Croissaint: dauerhaft aktiv",
        menuEnableAwake: "Wachhalten aktivieren",
        menuDisableAwake: "Wachhalten deaktivieren",
        menuActivateFor: "Aktivieren für…",
        menuSettings: "Einstellungen…",
        menuAbout: "Über Croissaint",
        menuQuit: "Croissaint beenden",
        menuHide: "Croissaint ausblenden",
        ...
        notifyBatteryTitle: "Croissaint deaktiviert",
        notifyBatteryBody: "Niedriger Batteriestand. Der normale Ruhezustand wurde wiederhergestellt, um die Ladung zu schonen.",
        adminPromptClamshellOn: "Croissaint benötigt dein Passwort, um bei zugeklapptem Mac weiterzulaufen.",
        adminPromptClamshellOff: "Croissaint benötigt dein Passwort, um den normalen Ruhezustand des Mac wiederherzustellen.",
        adminPromptRecover: "Croissaint wurde beendet, während der Ruhezustand des Mac deaktiviert war. Gib das Passwort ein, um den normalen Ruhezustand wiederherzustellen.",
        adminPromptUpdate: "Croissaint benötigt dein Passwort, um das Update zu installieren.",
        adminPromptSudoersInstall: "Croissaint legt eine eingeschränkte Regel an (nur pmset disablesleep), um den Modus bei geschlossenem Display ohne Passwortabfrage umzuschalten. Nur dieses eine Mal wird das Passwort benötigt.",
        adminPromptSudoersRemove: "Croissaint entfernt die passwortfreie Regel für das geschlossene Display.",

        settingsTitle: "Croissaint-Einstellungen",
        ...
        advancedResetDescription: "Entfernt alle Berechtigungen, die du Croissaint erteilt hast (Bedienungshilfen, Bildschirmaufnahme, Festplattenvollzugriff und weitere), das Anmeldeobjekt und die Regel für das geschlossene Display. Praktisch für einen Neustart oder vor dem Deinstallieren. Die App bleibt installiert.",
        ...
        advancedUninstallDescription: "Macht alles oben Genannte, entfernt dann die Einstellungen und bewegt Croissaint in den Papierkorb, ohne Rückstände zu hinterlassen. Die App beendet sich danach. Du kannst sie jederzeit neu installieren.",
        advancedUninstallButton: "Croissaint vollständig deinstallieren",
        advancedUninstallConfirmTitle: "Croissaint deinstallieren?",
        advancedUninstallConfirmBody: "Croissaint setzt seine Berechtigungen zurück, entfernt seine Einstellungen und wandert in den Papierkorb, dann beendet es sich. Das lässt sich aus der App nicht rückgängig machen, doch sie bleibt im Papierkorb, bis du ihn leerst.",
        advancedUninstallFailedTitle: "Deinstallation gestoppt",
        advancedUninstallFailedBody: "Croissaint konnte eine geänderte Systemeinstellung nicht wiederherstellen: Ruhezustand, Lüfterdrehzahl oder Mausbeschleunigung. Es wurde nichts entfernt. Versuche es erneut und erlaube die Kennwortabfrage, falls sie erscheint.",
        ...
        keepAwakeAutoStart: "Beim Öffnen von Croissaint wach halten",
        ...
        switcherEnable: "Croissaint-Umschalter verwenden",
        ...
        switcherTakeOverSystemShortcutsCaption: "Deaktiviert die passenden macOS-App- und Fensterkurzbefehle nur, solange Croissaints Umschalter aktiv ist. Alle laufenden Apps bleiben erreichbar.",
        ...
        uninstallerFDAHint: "Aktiviere Croissaint in der Liste. Fehlt es dort, klicke auf + und wähle Croissaint unter „Programme“. Der Zugriff gilt erst, nachdem du die App erneut öffnest.",
        ...
        homebrewMissingBody: "Croissaint kann Terminal mit dem offiziellen Homebrew-Installer öffnen. Terminal zeigt die Schritte und fragt bei Bedarf nach deinem Passwort.",
        ...
        homebrewShellSetupBody: "Homebrew ist installiert, aber Terminal findet den Befehl brew vielleicht noch nicht. Croissaint kann Terminal mit dem Konfigurationsbefehl öffnen.",
        ...
        homebrewTerminalFallback: "Diese Aktion benötigt Terminal, um nach dem Administratorpasswort zu fragen. Croissaint erfasst keine Passwörter.",
        ...
        updateNeedsApplicationsTitle: "Bewege Croissaint in den Ordner „Programme“",
        updateNeedsApplicationsBody: "Die App läuft an einem Ort, der nicht aktualisiert werden kann, etwa im Disk-Image oder an einem temporären Systemort. Ziehe Croissaint in den Ordner „Programme“, öffne es von dort und versuche es erneut.",
        ...
        obStart: "Croissaint öffnen",
        obStepWelcomeTitle: "Willkommen bei Croissaint",
        ...
        obStepDoneBody: "Croissaint kümmert sich bereits um deinen Mac.",
        ...
        obLanguageUpdateBody: "Croissaint spricht jetzt mehrere Sprachen. Wähle die, die du verwenden möchtest; du kannst sie jederzeit in den Einstellungen ändern.",
        ...
        cleaningNeedsAxBody: "Um die Tastatur sicher zu sperren, benötigt Croissaint die Berechtigung für Bedienungshilfen. Erteile sie in den Systemeinstellungen und versuche es erneut.",
        ...
        donateHeading: "Hilf Croissaint weiter zu wachsen",
        donateMessage: "Croissaint ist kostenlos, unabhängig und entsteht in meiner Freizeit. Wenn du die Entwicklung finanziell unterstützen möchtest, hilft GitHub Stars direkt dabei, sie voranzubringen.",
        donateButton: "Über GitHub Stars unterstützen",
        donateThanks: "Danke, dass du hier bist. 🖤",
        supportIntroTitle: "Hilf Croissaint weiter zu wachsen",
        supportIntroMessage: "Wenn du die Entwicklung finanziell unterstützen möchtest, ist GitHub Stars der einzige Ort dafür.",
        supportIntroStarButton: "Croissaint auf GitHub einen Stern geben",
        supportIntroStarMessage: "Finanzielle Unterstützung wird nie erwartet. Ein Stern auf GitHub hilft mehr Menschen, Croissaint zu entdecken, und macht für die Entwicklung einen echten Unterschied.",
        supportIntroCoffeeButton: "Über GitHub Stars unterstützen",
        ...
        homebrewOfficialIntroMessage: "Croissaint kann jetzt direkt aus dem offiziellen Katalog von Homebrew installiert werden.",
        ...
        showMenuBarIconCaption: "Falls das Symbol von Croissaint verschwindet (macOS kann Menüleistensymbole ausblenden, wenn der Platz in der Leiste knapp wird, häufig bei Macs mit Notch), öffne Croissaint erneut über „Programme“ oder Spotlight: Das stellt das Symbol wieder her und öffnet, falls es weiterhin ausgeblendet ist, dieses Fenster.",
        ...
        menuBarIconManagerHintFormat: "%@ läuft und hält das Symbol womöglich in seinem verborgenen Bereich. Suche Croissaint dort, oder stelle %@ so ein, dass Croissaint immer angezeigt wird.",
        ...
        cleanerNotifDenied: "Mitteilungen von Croissaint sind im System deaktiviert.",
        cleanerNotifOpenSettings: "Mitteilungseinstellungen öffnen…",
        launchAtLoginNeedsApplications: "Die App läuft von einem Ort, der das Öffnen bei der Anmeldung nicht erlaubt. Ziehe Croissaint in den Ordner Programme, öffne die App von dort und schalte die Option wieder ein.",
        launchAtLoginNeedsApproval: "Das Anmeldeobjekt ist registriert, in den Systemeinstellungen aber weiterhin aus. Öffne Systemeinstellungen › Allgemein › Anmeldeobjekte & Erweiterungen und schalte Croissaint unter „Bei der Anmeldung öffnen“ ein.",
        ...
        mouseAccelerationCaption: "Deaktiviert die Zeigerbeschleunigung für angeschlossene Mäuse. Die vorherige Einstellung wird beim Ausschalten oder Beenden von Croissaint wiederhergestellt.",
