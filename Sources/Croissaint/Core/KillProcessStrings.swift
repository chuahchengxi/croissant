...
extension KillProcessFeatureStrings {
    static let enUS = KillProcessFeatureStrings(
        ...
        adminPromptFormat: "Croissaint needs administrator access to end “%@”."
    )
    ...
    static let ptBR = KillProcessFeatureStrings(
        ...
        adminPromptFormat: "O Croissaint precisa de acesso de administrador para encerrar “%@”."
    )
    ...
    static let tr = KillProcessFeatureStrings(
        ...
        adminPromptFormat: "Croissaint’in “%@” işlemini sonlandırması için yönetici erişimi gerekiyor."
    )
    ...
    static let ru = KillProcessFeatureStrings(
        ...
        adminPromptFormat: "Croissaint нужны права администратора, чтобы завершить «%@»."
    )
    ...
    static let es = KillProcessFeatureStrings(
        ...
        adminPromptFormat: "Croissaint necesita acceso de administrador para finalizar “%@”."
    )
    ...
    static let de = KillProcessFeatureStrings(
        ...
        adminPromptFormat: "Croissaint benötigt Administratorrechte, um „%@“ zu beenden."
    )
    ...
    static let fr = KillProcessFeatureStrings(
        ...
        adminPromptFormat: "Croissaint a besoin d’un accès administrateur pour arrêter «\u{00A0}%@\u{00A0}»."
    )
    ...
    static let it = KillProcessFeatureStrings(
        ...
        adminPromptFormat: "Croissaint richiede l’accesso da amministratore per terminare “%@”."
    )
    ...
    static let zhHans = KillProcessFeatureStrings(
        ...
        adminPromptFormat: "Croissaint 需要您的管理员密码才能结束“%@”。"
    )
    ...
    static let zhTW = KillProcessFeatureStrings(
        ...
        adminPromptFormat: "Croissaint 需要管理員權限才能結束「%@」。"
    )
