...
extension PermissionGuideStrings {
    static let ko = PermissionGuideStrings(
        ...
        stepToggle: "그 목록에서 Croissaint를 켜세요.",
...
extension PermissionGuideStrings {
    static let enUS = PermissionGuideStrings(
        ...
        stepToggle: "Turn Croissaint on in that list.",
    ...
    static let ptBR = PermissionGuideStrings(
        ...
        stepToggle: "Ligue o Croissaint nessa lista.",
    ...
    static let tr = PermissionGuideStrings(
        ...
        stepToggle: "O listede Croissaint’i açın.",
    ...
    static let ru = PermissionGuideStrings(
        ...
        stepToggle: "Включите Croissaint в этом списке.",
    ...
    static let es = PermissionGuideStrings(
        ...
        stepToggle: "Activa Croissaint en esa lista.",
    ...
    static let de = PermissionGuideStrings(
        ...
        stepToggle: "Schalte Croissaint in dieser Liste ein.",
    ...
    static let fr = PermissionGuideStrings(
        ...
        stepToggle: "Activez Croissaint dans cette liste.",
    ...
    static let it = PermissionGuideStrings(
        ...
        stepToggle: "Attiva Croissaint in quell’elenco.",
    ...
    static let ja = PermissionGuideStrings(
        ...
        stepToggle: "そのリストでCroissaintをオンにしてください。",
