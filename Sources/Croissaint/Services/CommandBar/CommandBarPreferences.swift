...
enum CommandBarSource: String, CaseIterable, Identifiable {
    /// What Croissaint itself can do. Always on: it is what the bar is for.
    case actions
    case apps
    case menus
    case windows
    case quitApps
    case settingsPages
    /// The Mac's own Settings panes, which are not Croissaint's and can be
...
enum CommandBarPreferences {
    ...
    ///
    /// What this Mac holds (the apps, Croissaint's own actions, the Settings
