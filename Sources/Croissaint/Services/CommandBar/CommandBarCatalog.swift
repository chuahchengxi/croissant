...
enum CommandBarCatalog {
    ...
    /// showing its own shortcut. This is how the bar reaches past Croissaint
    ...
    /// runs, so one row serves both "gh" and "gh croissaint".
    ...
    private static func keepOnShelf(_ text: String) {
        let board = NSPasteboard(name: NSPasteboard.Name("com.croissaint.commandbar.selection"))
        board.clearContents()
