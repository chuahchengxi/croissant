...
final class WindowUseTracker {
    ...
    @objc private func appActivated(_ note: Notification) {
        ...
        // self-activating on the way out; ranking it would put Croissaint ahead
        // of the app the user left. Every other activation of Croissaint, the
    ...
    private func startWatcher() {
        let thread = lifecycleLock.withLock { () -> Thread? in
            ...
            thread.name = "Croissaint Window Focus"
