...
enum AdminShell {
    // Croissaint is a menu-bar agent (LSUIElement), so it is rarely the active
...
enum Sudoers {
    ...
    private static let sleepStateQueue = DispatchQueue(label: "com.croissaint.utils.pmset-state")
