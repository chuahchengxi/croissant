...
final class FanControlService: ObservableObject {
    ...
    private let probeQueue = DispatchQueue(label: "com.croissaint.fan-control.probe",
                                           qos: .utility)
    ...
    private static var helperVersion: String {
        Bundle.main.object(forInfoDictionaryKey: "CroissaintFanControlHelperVersion") as? String
