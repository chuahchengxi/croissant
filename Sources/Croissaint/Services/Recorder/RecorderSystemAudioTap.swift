...
final class RecorderSystemAudioTap: @unchecked Sendable {
    ...
    private static let teardownQueue = DispatchQueue(label: "com.croissaint.recorder.systemaudio.teardown",
                                                     qos: .utility)
    ...
    static func make() async -> RecorderSystemAudioTap? {
        ...
        let queue = DispatchQueue(label: "com.croissaint.recorder.systemaudio",
                                  qos: .userInitiated)
    ...
    private init?(queue: DispatchQueue) {
        ...
        description.name = "Croissaint Recorder"
    ...
    private func buildPipeline() {
        ...
        let aggregate: [String: Any] = [
            kAudioAggregateDeviceNameKey: "Croissaint Recorder",
