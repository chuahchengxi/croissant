...
final class RecorderCaptureEngine: NSObject {
    ...
    private let queue = DispatchQueue(label: "com.croissaint.recorder.capture",
                                      qos: .userInitiated)
    ...
    /// Builds the filter and starts the stream. Existing ordinary Croissaint
...
final class RecorderMicrophoneCapture: NSObject,
    ...
    private let queue = DispatchQueue(label: "com.croissaint.recorder.microphone",
                                      qos: .userInitiated)
