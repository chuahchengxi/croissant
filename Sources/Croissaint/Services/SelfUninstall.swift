...
enum SelfUninstall {
    private static var bundleID: String { Bundle.main.bundleIdentifier ?? "com.croissaint.utils" }
    ...
    /// bundle to the Trash and quits. Used by "Uninstall Croissaint completely".
    ...
    private static func trashOwnBundleAndQuit() {
        ...
        let scriptURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("croissaint-uninstall-\(pid)-\(UUID().uuidString).sh")
        do {
