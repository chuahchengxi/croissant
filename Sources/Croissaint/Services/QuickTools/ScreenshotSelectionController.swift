...
final class ScreenshotSelectionController {
    ...
    private var hideCroissaintWindows: Bool
    ...
    init(freeze: Bool,
         includePointer: Bool,
         showLastRegion: Bool,
         hideCroissaintWindows: Bool = true,
        ...
        self.hideCroissaintWindows = hideCroissaintWindows
        ...
        self.capturePolicy = ScreenshotSupport.UnifiedCapturePolicy(
            ...
            hideCroissaintWindows: hideCroissaintWindows,
        ...
        if freeze {
            Task { @MainActor [weak self] in
                ...
                let images = await ScreenshotCaptureEngine.captureAllDisplays(
                    ...
                    hideCroissaintWindows: self.hideCroissaintWindows,
    ...
    private func screenCaptureToolDidChange() {
        if let activeTool {
            ...
            let nextPolicy = ScreenshotSupport.unifiedCapturePolicy(
                ...
                screenshotHideCroissaintWindows: defaults.bool(
                    forKey: DefaultsKey.screenshotHideCroissaintWindows))
    ...
    private func adoptCapturePolicy(_ policy: ScreenshotSupport.UnifiedCapturePolicy) {
        ...
        hideCroissaintWindows = policy.hideCroissaintWindows
        sourceGeneration += 1
    ...
    private func loadLiveLoupeImages() {
        let hideWindows = hideCroissaintWindows
        let excludedIDs = captureExcludedWindowIDs
        Task { @MainActor [weak self] in
            let images = await ScreenshotCaptureEngine.captureAllDisplays(
                includePointer: false,
                hideCroissaintWindows: hideWindows,
