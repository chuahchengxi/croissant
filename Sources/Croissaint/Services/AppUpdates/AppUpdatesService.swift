...
final class AppUpdatesService: ObservableObject {
    ...
    private let workQueue = DispatchQueue(label: "com.croissaint.appupdates", qos: .utility)
    ...
    private static func isOwnBundle(_ bundleID: String) -> Bool {
        bundleID == Bundle.main.bundleIdentifier || bundleID.hasPrefix("com.croissaint")
    }

    private static let ownPackageTokens: Set<String> = ["croissaint", "croissaint@beta", "croissaint-beta"]
