...
/// activation this app holds, and Croissaint (`LSUIElement`, non-activating
...
enum ActivationHandoff {
    ...
    /// Past that, an activation of Croissaint is the user opening one of its
    ...
    /// Whether the activation of Croissaint being reported right now is the one
