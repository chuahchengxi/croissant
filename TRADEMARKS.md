...
The GPL license does not grant permission to use the Croissaint name, logo, icon,
bundle identity, trade dress, official branding, or any signing identity
controlled by the project maintainer.

Official Croissaint builds are distributed only by the project maintainer.
...
Do not present a modified build as Croissaint or as an official release unless
